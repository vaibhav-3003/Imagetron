...
const CreatePin = ({user}) => {
  ...
  const uploadImage = (e) =>{
    ...
    if(type === 'image/png' || type === 'image/jpeg' || type==='image/svg' || type==='image/gif' || type==='image/tiff' || type==='image/svg+xml'){
    ...
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full '>
        ...
        <div className='flex flex-col gap-6 py-3 mt-8 w-full'>
              ...
              {user && (
                <div className='flex gap-2 my-2 mt-0 items-center bg-white rounded-lg'>
